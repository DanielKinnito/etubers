		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php
					...
					if ($table->num_rows > 0) {
						// Output table header
						echo '<table class="table" id="manageMaterialTable">
								<thead>
									<tr>
						...
						while ($row = $table->fetch_assoc()) {
							echo '<tr>
									...
									<td>
										<button class="btn btn-primary" data-toggle="modal" data-target="#editMaterialModal" data-id="' . $row['MaterialID'] . '">Edit</button>
										<button class="btn btn-danger" data-toggle="modal" data-target="#removeMaterialModal" data-id="' . $row['MaterialID'] . '">Delete</button>
									</td>
								</tr>';
						}
